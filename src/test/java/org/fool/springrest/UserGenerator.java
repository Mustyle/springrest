...
public class UserGenerator {
	...
	public static void main(String[] args) {
		...
		String[][] users = { { "1", "mickey", "cheese", "Mickey", "Mouse", "no" },
				{ "2", "minnie", "red01", "Minnie", "Mouse", "no" }, { "3", "donald", "quack", "Donald", "Duck", "no" },
		...
		for (String[] user : users) {
			...
			System.out.println(
					String.format(sql, user[0], user[1], passwordEncoder.encode(user[2]), user[3], user[4], user[5]));
